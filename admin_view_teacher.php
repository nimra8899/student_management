...
<body>
  ...
  <table border="1px">
    ...
    <tr>
      <td style="font-size: 20px" s class="table_td"><?php echo "{$info['name']}"; ?></td>
      <td style="font-size: 20px" class="table_td"><?php echo "{$info['description']}"; ?></td>
      <td style="font-size: 20px" class="table_td"><img height="100px" width="100px" src="<?php echo "{$info['image']}" ?>"> 
      </td>  
